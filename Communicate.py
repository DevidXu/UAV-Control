...
class communication(Factory):
    ...
    def waitMove(self, ori_pos, angle, info=None):
        ...
        MID0 = (self.UAV.region.cubePoint[0][0]+self.UAV.region.cubePoint[1][0])/2
        MID2 = (self.UAV.region.cubePoint[0][2]+self.UAV.region.cubePoint[1][2])/2
        if pos[0]<=MID0: pos[0] -= 1.0
        elif pos[0]>MID0: pos[0] += 1.0
        elif pos[2]<MID2: pos[2] -= 1.0
        elif pos[2]>MID2: pos[2] += 1.0
...
# 3442386.789452:1.400000:13473041.694578'